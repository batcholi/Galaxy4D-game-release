...
void main() {
	if (renderer.terrain_clutter_detail > 0 && approxDistanceFromCamera < maxDrawDistance && GetFixedBoundingSizeInScreenPixels(approxDistanceFromCamera, rockBoundingSize) > 43) {
