			...
			RAY_RECURSION_PUSH
				RAY_SHADOW_PUSH
					...
					for (int i = 0; i < MAX_SHADOW_TRANSPARENCY_RAYS; ++i) {
						traceRayEXT(tlas, 0, ~(RAYTRACE_TYPE_WATER | RAYTRACE_TYPE_ATMOSPHERE), 0/*rayType*/, 0/*nbRayTypes*/, 0/*missIndex*/, rayOrigin, shadowRayStart, sunDir, xenonRendererData.config.zFar, 0);
